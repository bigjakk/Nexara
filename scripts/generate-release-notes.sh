...
VERSION="${TAG#v}"
echo "docker pull ghcr.io/bigjakk/nexara-api:${VERSION}"
echo "docker pull ghcr.io/bigjakk/nexara-ws:${VERSION}"
echo "docker pull ghcr.io/bigjakk/nexara-collector:${VERSION}"
echo "docker pull ghcr.io/bigjakk/nexara-scheduler:${VERSION}"
echo "docker pull ghcr.io/bigjakk/nexara-frontend:${VERSION}"
echo ""
