...
func TestVmidFromUPID_OnlyGuestTaskTypes(t *testing.T) {
	tests := []struct {
		...
		// Guest task families.
		{"qemu start", "UPID:pve-01:001316BE:00B8B463:6A8CE407:qmstart:110:root@pam!nexara:", 110},
		{"qemu destroy", "UPID:pve-03:001316BE:00B8B463:6A8CE407:qmdestroy:121:root@pam:", 121},
		{"lxc start", "UPID:pve-01:001316BE:00B8B463:6A8CE407:vzstart:104:root@pam:", 104},
		{"guest backup", "UPID:pve-01:001316BE:00B8B463:6A8CE407:vzdump:101:root@pam:", 101},
		{"ha migrate", "UPID:pve-01:001316BE:00B8B463:6A8CE407:hamigrate:125:root@pam:", 125},
		// Carry a VMID without a guest prefix.
		{"disk resize", "UPID:pve-01:001316BE:00B8B463:6A8CE407:resize:102:root@pam:", 102},
		{"volume move", "UPID:pve-01:001316BE:00B8B463:6A8CE407:move_volume:102:root@pam:", 102},

		// Numeric worker id that is NOT a VMID — the whole point.
		{"ceph osd destroy", "UPID:pve-01:001316BE:00B8B463:6A8CE407:cephdestroyosd:113:root@pam:", 0},
		...
		{"absurd id is rejected, not truncated", "UPID:pve-01:0000A1B2:00000001:6A8CE407:qmstart:1234567890:root@pam:", 0},
		{"zero is not a vmid", "UPID:pve-01:0000A1B2:00000001:6A8CE407:qmstart:0:root@pam:", 0},
	}
