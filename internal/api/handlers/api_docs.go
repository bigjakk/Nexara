...
var endpointMeta = map[string]APIEndpoint{
	...
	"GET /api/v1/clusters/:id/vms/:vm_id/snapshot-capability":            {Description: "Check whether the VM's configuration supports snapshots", Permission: "view:vm", Group: "Virtual Machines"},
	...
	"GET /api/v1/clusters/:id/containers/:ct_id/snapshot-capability": {Description: "Check whether the container's configuration supports snapshots", Permission: "view:container", Group: "Containers"},
