...
var apiEndpoints = []APIEndpoint{
	...
	{Method: "POST", Path: "/api/v1/auth/console-token", Description: "Mint a short-lived scope-locked JWT for a specific console WebSocket (mobile)", Permission: "view:vm|view:container|view:node", Group: "Authentication"},
	{Method: "POST", Path: "/api/v1/me/devices", Description: "Register a mobile device for push notifications", Permission: "", Group: "Mobile Devices"},
	{Method: "GET", Path: "/api/v1/me/devices", Description: "List the current user's registered mobile devices", Permission: "", Group: "Mobile Devices"},
	{Method: "DELETE", Path: "/api/v1/me/devices/:id", Description: "Remove one of the current user's registered mobile devices", Permission: "", Group: "Mobile Devices"},
	{Method: "GET", Path: "/api/v1/admin/users/:id/devices", Description: "List a user's registered mobile devices", Permission: "manage:user", Group: "Mobile Devices"},
	{Method: "DELETE", Path: "/api/v1/admin/devices/:id", Description: "Remove a mobile device (admin)", Permission: "manage:user", Group: "Mobile Devices"},
