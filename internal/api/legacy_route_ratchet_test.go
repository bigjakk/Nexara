...
var legacyRouteBaseline = map[string]bool{
	...
	"DELETE /api/v1/clusters/:cluster_id/ha/groups/:group":                                 true,
	"DELETE /api/v1/clusters/:cluster_id/ha/resources/:sid":                                true,
	"DELETE /api/v1/clusters/:cluster_id/ha/rules/:rule":                                   true,
	...
	"DELETE /api/v1/clusters/:cluster_id/replication/:job_id":                              true,
	...
	"GET /api/v1/clusters/:cluster_id/ceph/fs":                                             true,
	"GET /api/v1/clusters/:cluster_id/ceph/metrics":                                        true,
	"GET /api/v1/clusters/:cluster_id/ceph/monitors":                                       true,
	"GET /api/v1/clusters/:cluster_id/ceph/osds":                                           true,
	"GET /api/v1/clusters/:cluster_id/ceph/osds/:osd_id/preflight":                         true,
	"GET /api/v1/clusters/:cluster_id/ceph/osds/metrics":                                   true,
	"GET /api/v1/clusters/:cluster_id/ceph/pools":                                          true,
	"GET /api/v1/clusters/:cluster_id/ceph/pools/metrics":                                  true,
	"GET /api/v1/clusters/:cluster_id/ceph/rules":                                          true,
	"GET /api/v1/clusters/:cluster_id/ceph/status":                                         true,
	...
	"GET /api/v1/clusters/:cluster_id/cve-scans/:scan_id":                                  true,
	"GET /api/v1/clusters/:cluster_id/cve-scans/:scan_id/vulnerabilities":                  true,
	"GET /api/v1/clusters/:cluster_id/description":                                         true,
	"GET /api/v1/clusters/:cluster_id/drs/config":                                          true,
	"GET /api/v1/clusters/:cluster_id/drs/ha-rules":                                        true,
	"GET /api/v1/clusters/:cluster_id/drs/history":                                         true,
	"GET /api/v1/clusters/:cluster_id/drs/rules":                                           true,
	...
	"GET /api/v1/clusters/:cluster_id/ha/groups":                                           true,
	"GET /api/v1/clusters/:cluster_id/ha/manager-status":                                   true,
	"GET /api/v1/clusters/:cluster_id/ha/resources":                                        true,
	"GET /api/v1/clusters/:cluster_id/ha/resources/:sid":                                   true,
	"GET /api/v1/clusters/:cluster_id/ha/rules":                                            true,
	"GET /api/v1/clusters/:cluster_id/ha/status":                                           true,
	...
	"GET /api/v1/clusters/:cluster_id/replication/:job_id":                                 true,
	"GET /api/v1/clusters/:cluster_id/replication/:job_id/log":                             true,
	"GET /api/v1/clusters/:cluster_id/replication/:job_id/status":                          true,
	...
	"GET /api/v1/clusters/:cluster_id/security-posture":                                    true,
	...
	"POST /api/v1/clusters/:cluster_id/ceph/osds/:osd_id/in":                               true,
	"POST /api/v1/clusters/:cluster_id/ceph/osds/:osd_id/out":                              true,
	"POST /api/v1/clusters/:cluster_id/ceph/osds/:osd_id/restart":                          true,
	...
	"POST /api/v1/clusters/:cluster_id/drs/rules":                                          true,
	...
	"POST /api/v1/clusters/:cluster_id/ha/arm":                                             true,
	"POST /api/v1/clusters/:cluster_id/ha/disarm":                                          true,
	"POST /api/v1/clusters/:cluster_id/ha/groups":                                          true,
	"POST /api/v1/clusters/:cluster_id/ha/resources":                                       true,
	"POST /api/v1/clusters/:cluster_id/ha/rules":                                           true,
	...
	"POST /api/v1/clusters/:cluster_id/replication":                                        true,
	"POST /api/v1/clusters/:cluster_id/replication/:job_id/trigger":                        true,
	...
	"PUT /api/v1/clusters/:cluster_id/drs/config":                                          true,
	...
	"PUT /api/v1/clusters/:cluster_id/ha/groups/:group":                                    true,
	"PUT /api/v1/clusters/:cluster_id/ha/resources/:sid":                                   true,
	"PUT /api/v1/clusters/:cluster_id/ha/rules/:rule":                                      true,
	...
	"PUT /api/v1/clusters/:cluster_id/replication/:job_id":                                 true,
